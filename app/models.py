...
class PipelineDetails(db.Model):
  ...
  catsalut_tiers   = db.Column(db.String(100))
  pipeline_version_source = db.Column(db.String(200))
  source_job_date  = db.Column(db.String(100))
  source_panel     = db.Column(db.String(120))
  source_logfile   = db.Column(db.String(500))
  annotation_yaml_version = db.Column(db.String(100))
  binary_yaml_version = db.Column(db.String(100))
  reference_yaml_version = db.Column(db.String(100))
  gencode_gtf_version = db.Column(db.String(100))
  spliceai_transcript_version = db.Column(db.String(100))
  revel_version = db.Column(db.String(100))
  vep_cache_version = db.Column(db.String(100))
  clinvar_version = db.Column(db.String(100))
  gene_synonyms_version = db.Column(db.String(100))
  gnomad_exomes_version = db.Column(db.String(100))
  gnomad_only_af_version = db.Column(db.String(100))
  gnomad_sv_version = db.Column(db.String(100))
  cadd_version = db.Column(db.String(100))
  spliceai_snv_version = db.Column(db.String(100))
  spliceai_indel_version = db.Column(db.String(100))
  maxent_version = db.Column(db.String(100))
  cancer_hotspots_version = db.Column(db.String(100))
  civic_db_version = db.Column(db.String(100))
  blacklist_version = db.Column(db.String(100))
  phastcons_version = db.Column(db.String(100))
  phylop_version = db.Column(db.String(100))
  mappability_version = db.Column(db.String(100))
  grapes_db_version = db.Column(db.String(100))
  grapes2_db_version = db.Column(db.String(100))
  bcftools_version = db.Column(db.String(100))
  bedtools_version = db.Column(db.String(100))
  bgzip_version = db.Column(db.String(100))
  freebayes_version = db.Column(db.String(100))
  gunzip_version = db.Column(db.String(100))
  ivar_version = db.Column(db.String(100))
  lancet_version = db.Column(db.String(100))
  megadepth_version = db.Column(db.String(100))
  mosdepth_version = db.Column(db.String(100))
  octopus_version = db.Column(db.String(100))
  seqtk_version = db.Column(db.String(100))
  strelka2_version = db.Column(db.String(100))
  tabix_version = db.Column(db.String(100))
  fastqc_version = db.Column(db.String(100))
  multiqc_version = db.Column(db.String(100))
  picard_version = db.Column(db.String(100))
  fgbio_version = db.Column(db.String(100))
  grapes_version = db.Column(db.String(100))
  grapes2_version = db.Column(db.String(100))
  decon_version = db.Column(db.String(100))
  ngs_binaries_version = db.Column(db.String(100))
  docker_vep_version = db.Column(db.String(100))
  docker_manta_version = db.Column(db.String(100))
  spliceai_docker_version = db.Column(db.String(100))
  deepvariant_version = db.Column(db.String(100))
